<template>
  <div class="row q-pa-md">
    <div class="col-sm-12">
      <h5 v-if="curricularComponent.id != null">
        Edição Componente Curricular <b>{{ curricularComponent.name }}</b>
      </h5>
      <h5 v-if="curricularComponent.id == null">
      ...
      <form v-on:submit.prevent="save()">
        <q-input
          filled
          v-model.trim="curricularComponent.name"
        ...
        <q-select
          ...
          v-model="curricularComponent.category"
          :options="categories"
        ...
        <q-select
          ...
          ransition-show="scale"
          transition-hide="scale"
          v-model="curricularComponent.nivel"
          :options="niveisEnsino"
          label="Nível Ensino relacionado"
          hint="Selecione uma categoria ao qual este componente curricular pertence"
          behavior="dialog"
        />
