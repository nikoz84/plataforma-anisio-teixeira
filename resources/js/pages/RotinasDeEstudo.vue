  ...
  <div class="q-pa-md">
    ...
    <div class="row justify-start q-gutter-md">
      <q-badge
        ...
        color="primary"
        label="Dica: Interaja com cards coloridos para acessar o conteúdo sugerido"
      />
    </div>
    <div v-if="rotinas && !mobile">
      <div
        class="row justify-start q-gutter-md"
        v-for="(rotina, i) in rotinas"
        :key="i"
      >
...
export default {
  ...
  data() {
    return {
      ...
      coresClasses: [
        "bg-amarelo text-left q-py-md q-mb-md",
        "bg-rosa text-left q-py-md q-mb-md",
        "bg-turquesa",
        "bg-verde text-left q-py-md q-mb-md",
        "bg-lilas text-left q-py-md q-mb-md",
      ],
