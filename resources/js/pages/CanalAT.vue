    ...
    <div v-if="canal">
      ...
      <article class="q-pa-lg row justify-center text-justify ">
        <div
          id="paragraph"
          class="col-md-9"
          v-html="canal.document.description"
        ></div>
      </article>
      ...
      <article class="q-pa-lg flex justify-center text-justify">
        ...
        >
          <p style="padding:0;margin:0">
            <iframe
              loading="lazy"
              src="https://padlet.com/embed/2dd8zchhneh80cnr"
              frameborder="0"
      ...
      <div class="row justify-center" style="margin-top:150px;">
        <article class="col-xs-12 col-md-5 q-mr-md">
          <q-btn
            stack
            to="/recursos-educacionais/listar?busca=podcast_at"
        ...
        <article class="col-xs-12 col-md-5">
          <q-btn
            stack
            to="/recursos-educacionais/conteudo/exibir/4900"
      ...
      <div class="q-pa-lg flex justify-center" style="margin-top:100px;">
        <div class="col-lg-8">
          <q-btn
            ...
            to="/recursos-educacionais/listar?busca=canal_at"
          ></q-btn>
        </div>
      </div>
