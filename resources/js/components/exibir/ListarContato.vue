  ...
  <div class="q-pa-md">
    ...
    <div class="col-lg-12 q-mt-xs" v-if="paginator && paginator.total > 0">
      ...
      >
        ...
        <tbody>
          <tr
            v-for="contato in paginator.data"
            :key="contato.id"
            :id="`item-${contato.id}`"
          >
            <td class="text-center" v-html="contato.action"></td>
            <td class="text-center" v-html="contato.name"></td>
            <td class="text-center" v-html="contato.subject"></td>
