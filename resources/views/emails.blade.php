		...
		<td class="header container">
				...
				<div class="content">
					<table bgcolor="#999999">
                        <tr>
                            <td><img src="http://pat.educacao.ba.gov.br/assets/img/logo.png" /></td>
                            <td><h6 class="collapse">{{ config('app.name') }}</h6></td>
                        </tr>
				    </table>
				</div>
...
<!-- TÍTULO -->
<table class="head-wrap" bgcolor="#668cff">
	<tr>
		<td></td>
		<td class="header container">
			<div class="content">
				...
				<tr>
					<td>
						<table class="social" width="100%">
							<tr>
								<td>
									<h3>O usuário {{ $email }} enviou uma denúncia.</h3>
