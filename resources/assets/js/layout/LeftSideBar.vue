<template>
  <nav>
    <q-list dense bordered padding separator>
      ...
      <!-- ADMINISTRAÇÃO -->
      <q-item v-if="isLogged" clickable to="/admin/dashboard/listar" aria-label="Painel de controle">
      ...
      <!-- HOME -->
      <q-item clickable to="/" aria-label="Inicio" active-class="active-link-pat">
        <q-item-section avatar>
          <q-icon name="home" />
        </q-item-section>
        <q-item-section>
    ...
    <q-list dense bordered padding separator v-if="links.length > 0">
      ...
      <q-item :to="{ name: 'canalAT' }" aria-label="IR: Canal Anísio Teixeira" title="IR: Canal Anísio Teixeira"
        clickable v-close-popup active-class="active-link-pat" tabindex="21">
        <q-item-section avatar>
    ...
    <q-list dense bordered>
      <q-expansion-item dense dense-toggle expand-separator label="Sobre a PAT">
        <q-separator />
        <!-- SOBRE -->
        <q-item clickable to="/sobre" aria-label="sobre a plataforma" active-class="active-link-pat">
          <q-item-section>
        ...
        <q-separator />
        <!-- GALERIA -->
        <q-item clickable to="/galeria" aria-label="visite a galería de imagens" active-class="active-link-pat">
          <q-item-section>
