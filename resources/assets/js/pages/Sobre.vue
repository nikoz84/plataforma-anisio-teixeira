      ...
      <q-card-section horizontal>
        ...
        <q-card-section>
          ...
          <div>
            ...
            <a href="http://www.educacao.ba.gov.br/anisioteixeira" target="new" style="float:right; font-size:1rem">Clique aqui para mais sobre a história de Anísio Teixeira</a>
          </div>
        </q-card-section>
      </q-card-section>
    </q-card>
