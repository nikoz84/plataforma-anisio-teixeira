<template>
  ...
  <div class="q-ma-md">
    ...
    <div class="row q-my-lg q-pt-md q-gutter-xs justify-start">
      ...
      >
        ...
        >
          <q-card-section horizontal>
            <q-icon
              class="col-4 q-pa-md q-icon-escuro"
              color="accent"
            >
              <img
        ...
        >
          <q-card-section horizontal>
            ...
            <q-card-section>
              ...
              >Você Sabia?</div>
              <div>
                <p>O IAT - Instituto Anísio Teixeira, órgão em regime especial de administração direta da Secretaria Estadual da Educação da Bahia, tal como a Plataforma Anísio Teixeira, recebem o nome de um dos maiores educadores do Brasil, responsável por mudanças de extrema relevância no cenário educacional do século XX. Baiano do município de Caetité, Anísio Spínola Teixeira difundiu o movimento da Escola Nova e defendeu como nenhum outro a Educação pública: gratuita, laica e obrigatória. </p>
                <a
    ...
    <div
      ...
      v-if="layout && layout.marcas"
    >
      <q-img
        alt="imagem de marcas"
        aria-label="imagem"
        style="max-width: 741px; height: auto; border-radius: 20px;"
    ...
    <div
      ...
      class="row wrap justify-center q-mt-lg"
    >
      ...
      <p class="col-12">
        <q-icon
          class="creative-commons-escuro"
          style="font-size: 10em; margin-top:-50px"
        >
          <img
