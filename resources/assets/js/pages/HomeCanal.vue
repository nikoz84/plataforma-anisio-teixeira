  ...
  <section class="q-pa-md">
    <q-card>
      <q-card-section>
        <div class="row">
          <div
            class="col-1 col-sm-2 q-pa-lg q-icon-escuro"
            thumbnail
          >
            <q-img
              src="/img/sobre/info.svg"
              alt=""
            />
          </div>
          <div class="col-11 col-sm-10 q-pl-md">
            ...
            <div
              class="q-pt-md text-small"
              v-html="canal.description"
            ></div>
          </div>
          <q-separator
