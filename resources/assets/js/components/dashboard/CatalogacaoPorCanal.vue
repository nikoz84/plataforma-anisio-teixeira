<template>
    <q-card>
        ...
        <q-card-section v-if="!isDashboard">
            <q-table v-if="render" title="Catalogação por canal" :data="dataTable" :columns="columns" color="primary"
...
export default {
    ...
    methods: {
        ...
        async getFiltros () {
            ...
            const { data } = await axios.get(`/dashboard/filtros/catalogacao-por-canal`);
