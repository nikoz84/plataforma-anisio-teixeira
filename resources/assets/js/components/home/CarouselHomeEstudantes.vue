<template>
  <div class="q-mb-xl q-mt-lg carousel_estudante">
    <q-responsive
      :ratio="16/4"
      style="max-width: 100%;heigth:25vh"
    >
      <q-carousel
        swipeable
        animated
...
export default {
  ...
  methods: {
    async getSlider() {
      ...
      for (let [i, dados] of this.slider.entries()) {
        if (dados.css != "carousel_estudante") {
