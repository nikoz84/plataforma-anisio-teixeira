                ...
                <q-card class="col-sm-12">
                    <q-card-section class="q-gutter-sm">
                        <q-input 
                            ...
                            filled v-model.trim="licenca.name" label="Nome:*" hint="Nome da Categoria por extenso"></q-input>
                        <!-- LICENCA -->
                        <q-select
                            outlined
                            option-value="id"
                        ...
                        <textarea v-model="licenca.description"
                        ...
                        <q-input 
                            ...
                            filled v-model.trim="licenca.site" label="Site referenciado: :*" 
                            hint="Url do site responsável pelas definições da licensa em questão"></q-input>
                        <!-- ICONE -->
                        <q-item-label style="margin-bottom:10px" >
                            <q-icon name="image" style="padding-bottom: 3px;" /><strong>Icone da licença</strong>
                        </q-item-label>
                        <q-img 
                        loading="lazy" 
...
export default {
    ...
    methods:{
        async save(){
            ...
            if(this.licenca.parent)
            form.append("parent_id", this.licenca.parent.id);
            ...
            try
            {
                if (this.$route.params.action == "editar") 
                {
                    ...
                    let resp = await axios.post(this.$route.params.slug +"/"+ this.licenca.id, form);
                }
                else
                {
